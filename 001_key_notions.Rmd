...
La _data science_ si pone all'intersezione tra statistica e informatica. La statistica è un insieme di metodi per raccogliere i dati ed estrarne informazione; l'informatica implementa tali procedure in un software. Iniziamo la nostra discussione introducendo alcuni concetti fondamentali.
