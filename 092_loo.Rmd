...
Nella scienza l'utilità di una teoria viene verificata eseguendo previsioni per osservazioni fatte in un esperimento in grado di falsificare detta teoria. Discrepanze significative tra osservazioni e previsioni suggeriscono che la teoria, o nella nostra visione più ristretta, il modello statistico, non è utile. La corrispondenza tra previsioni e osservazioni descrive, non soltanto la capacità del modello di rendere conto delle osservazioni di un campione di dati, ma anche la sua capacità di generalizzazione.
...
1. Come è possibile quantificare la capacità predittiva di un modello sulla base delle informazioni di un campione di osservazioni?
1. Come possiamo confrontare le capacità predittive di modelli alternativi?
...
Ma come è possibile valutare l'accuratezza (predittiva) di un modello? Per rispondere a questa domanda @McElreath_rethinking nota che è necessario evitare due errori opposti:

- il _sovra-adattamento_ (_overfitting_) --- il modello non si generalizza bene a nuovi dati futuri perché fa leva informazioni irrilevanti presenti nel campione  esaminato; tali aspetti idiosincratici del campione necessariamente non si ritroveranno in futuri campioni di dati;

- il _sotto-adattamento_ (_underfitting_) --- il modello non è neppure in grado di rendere conto delle regolarità presenti nei dati esaminati.

Tale problema va sotto il nome di _bias-variance trade-off_: il sotto-adattamento può portare a distorsioni (_bias_) dei parametri mentre il sovra-adattamento può portare a previsioni scadenti in campioni futuri. Spesso l'incertezza relativa alla scelta del modello (sotto-adattamento versus sovra-adattamento) passa inosservata anche se il suo impatto può essere molto grave.
