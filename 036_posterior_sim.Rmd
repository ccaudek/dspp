...
```{block, type='Summary'}
La distribuzione a posteriori può essere approssimata con il metodo basato su griglia. A causa della maledizione della dimensionalità, tuttavia, questo metodo è di utilità limitata. I metodi Monte Carlo a catena di Markov consentono invece di trovare sempre una soluzione a questo problema. Esamineremo qui l'algoritmo di Metropolis.
```
