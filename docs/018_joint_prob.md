...
Su tale spazio campionario consideriamo le variabili aleatorie $X \in \{0, 1, 2, 3\}$ che conta il numero delle teste nei tre lanci e $Y \in \{0, 1\}$ che conta il numero delle teste al primo lancio. Indicando con T = 'testa' e C = 'croce', si ottiene dunque la situazione riportata nella tabella \@ref(tab:tre-monete-distr-cong-1).
