...
Per passare dalle credenze precedenti alle credenze posteriori si usa la procedura dell'aggiornamento bayesiano. La regola di Bayes include tre componenti: distribuzione a priori, verosimiglianza e distribuzione a posteriori. Verrà qui esaminata la verosimiglianza.
:::
...
{\centering \includegraphics[width=0.8\linewidth]{images/rethinking_fig_2_5} 
