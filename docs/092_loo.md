...
Per approfondire questi temi, si rinvia al testo di @Johnson2022bayesrules. Qui ci concentreremo sul tema della "validità" del modello.
...
y_data <- rbeta(n, 1, 3)
head(y_data)
#> [1] 0.45402911 0.15688894 0.10650743 0.14823250 0.28309208
#> [6] 0.02276748
```
\noindent
