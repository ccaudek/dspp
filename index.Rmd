...
Data della versione presente: `r format(Sys.Date(), "%B %d, %Y")`.
:::
...
>
> `r tufte::quote_footer('--- Richard McElreath')`
...
>
> `r tufte::quote_footer('--- Richard Phillips Feynman')`
