...
\NormalTok{S }\OtherTok{\textless{}{-}} \FunctionTok{data.frame}\NormalTok{(out) }\SpecialCharTok{\%\textgreater{}\%}
...
\NormalTok{    )}
\NormalTok{  )}
\NormalTok{prob\_dist2}\SpecialCharTok{$}\NormalTok{Type }\OtherTok{\textless{}{-}} \FunctionTok{rep}\NormalTok{(}\FunctionTok{c}\NormalTok{(}\StringTok{"actual"}\NormalTok{, }\StringTok{"simulated"}\NormalTok{), }\AttributeTok{each =} \DecValTok{8}\NormalTok{)}
\end{Highlighting}
\end{Shaded}
