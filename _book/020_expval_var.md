...
$$
<!-- Infatti, se una variabile casuale discreta $Y$ ha una distribuzione di massa di probabilità $p(Y)$, allora il suo valore atteso sarà -->

<!-- $$ -->
<!-- \E(Y) = \sum_{-\infty}^{\infty} y_i p(y_i). -->
<!-- $$ -->
