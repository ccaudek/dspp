...
La costante di normalizzazione per i dati di @zetschefuture2019 si ottiene marginalizzando la funzione di verosimiglianza $p(y = 23, n = 30 \mid \theta)$ sopra $\theta$, ovvero risolvendo l'integrale:
\begin{equation}
